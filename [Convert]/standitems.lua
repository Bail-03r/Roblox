...
local Hat = AlignChar:FindFirstChild("CapMarvel")
...
Align(Hat.Handle,AlignChar.Reanim['THE NOOB'].Head,Vector3.new(0,.5,.5),Vector3.new(0,0,0))

--Right Arm
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("Pal Hair")
Hat.Handle.Mesh:Destroy()
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanim['THE NOOB']['Right Arm'],Vector3.new(0,0,0),Vector3.new(90,0,0))

--Left Arm
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("LavanderHair")
Hat.Handle.Mesh:Destroy()
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanim['THE NOOB']['Left Arm'],Vector3.new(0,0,0),Vector3.new(90,0,0))

--Right Leg
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("MessyHair")
Hat.Handle.Mesh:Destroy()
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanim['THE NOOB']['Right Leg'],Vector3.new(0,0,0),Vector3.new(90,0,0))

--Left Leg
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("Hat1")
Hat.Handle.Mesh:Destroy()
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanim['THE NOOB']['Left Leg'],Vector3.new(0,0,0),Vector3.new(90,0,0))

--Torso
local AlignChar = game.Players.LocalPlayer.Character
local Hat = AlignChar:FindFirstChild("LongStraightHair")
Hat.Handle.Mesh:Destroy()
Hat.Handle.AccessoryWeld:Destroy()
Align(Hat.Handle,AlignChar.Reanim['THE NOOB']['Torso'],Vector3.new(0,0,0),Vector3.new(0,90,0))

game.RunService.Heartbeat:Connect(function()
    for i,v in pairs(AlignChar.Reanim['THE NOOB']:GetChildren()) do
       if v:IsA('Part') then
           v.Transparency = 1
       end
    end
